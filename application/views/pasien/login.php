                ...
                <div class="p-5">
                  ...
                  <form class="user" action="<?php echo base_url().'welcome/login'; ?>" method="post">
                    <div class="form-group">
                      <input name="nim" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nim/Nip" autocomplete="off">
                    </div>
                    <div class="form-group">
